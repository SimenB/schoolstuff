...
public class AllForecastsAdapter extends BaseAdapter {
    ...
    public AllForecastsAdapter(final ArrayList<WeatherData> data, final LayoutInflater inflater) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.txtLonView.setText("Longitude" + weatherData.getPosition().longitude);
            holder.txtLatView.setText("Longitude" + weatherData.getPosition().latitude);
            holder.txtDateView.setText(weatherData.getCreated().toString());
